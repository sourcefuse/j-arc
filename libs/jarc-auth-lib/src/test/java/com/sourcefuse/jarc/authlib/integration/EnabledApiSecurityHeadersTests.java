...
import com.sourcefuse.jarc.authlib.test.app.condig.EnabledApiSecurityAppConfig;

@SpringBootTest
@Import(EnabledApiSecurityAppConfig.class)
@AutoConfigureMockMvc
public class EnabledApiSecurityHeadersTests {
