...
public final class MiddlewareConstants {
	...
	public static final Set<String> ALLOWED_PERMITTED_CROSS_DOMAIN_POLICIES = Set.of("none", "master-only",
			"by-content-type", "all");

	public static final Set<String> ALLOWED_REFFERER_POLICY_TOKENS = Set.of("no-referrer", "no-referrer-when-downgrade",
			SAME_ORIGIN, "origin", "strict-origin", "origin-when-cross-origin", "strict-origin-when-cross-origin",
			"unsafe-url", "");

	public static final Set<String> ALLOWED_CROSS_ORIGIN_RESOURCE_POLICIES = Set.of(SAME_ORIGIN, "same-site",
			"cross-origin");

	public static final Set<String> ALLOWED_CROSS_ORIGIN_OPENER_POLICIES = Set.of(SAME_ORIGIN,
			"same-origin-allow-popups", "unsafe-none");

	public static final Set<String> ALLOWED_CROSS_ORIGIN_EMBEDDER_POLICIES = Set.of("require-corp", "credentialless");
