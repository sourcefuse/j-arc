package com.sourcefuse.jarc.services.usertenantservice.commonutils;
...
public class CommonUtils<T> {
    ...
    public void copyProperties(T source, T destination) {
        ...
        if (source instanceof Group && destination instanceof Group) {
            if (((Group) source).getId() != null)
                ((Group) destination).setId(((Group) source).getId());
            if (((Group) source).getName() != null)
                ((Group) destination).setName(((Group) source).getName());
            if (((Group) source).getDescription() != null)
                ((Group) destination).setDescription(((Group) source).getDescription());
            if (((Group) source).getPhotoUrl() != null)
                ((Group) destination).setPhotoUrl(((Group) source).getPhotoUrl());
            if (((Group) source).getGroupType() != null)
                ((Group) destination).setGroupType(((Group) source).getGroupType());
            if (((Group) source).getUserGroups() != null)
                ((Group) destination).setUserGroups(((Group) source).getUserGroups());
            if (((Group) source).getCreatedBy() != null)
                ((Group) destination).setCreatedBy(((Group) source).getCreatedBy());
            if (((Group) source).getCreatedOn() != null)
                ((Group) destination).setCreatedOn(((Group) source).getCreatedOn());
            if (((Group) source).getModifiedBy() != null)
                ((Group) destination).setModifiedBy(((Group) source).getModifiedBy());
            if (((Group) source).getModifiedOn() != null)
                ((Group) destination).setModifiedOn(((Group) source).getModifiedOn());
            if (((Group) source).getDeletedBy() != null)
                ((Group) destination).setDeletedBy(((Group) source).getDeletedBy());
            if (((Group) source).getDeletedOn() != null)
                ((Group) destination).setDeletedOn(((Group) source).getDeletedOn());
            if (((Group) source).isDeleted())
                ((Group) destination).setDeleted(true);
        }
