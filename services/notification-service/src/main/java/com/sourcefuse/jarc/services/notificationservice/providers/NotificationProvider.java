...
public class NotificationProvider implements INotification {
	...
	public void publish(Message message) {
		if (message.getType().equals(MessageType.EMAIL) && emailNotification != null) {
			emailNotification.publish(message);
		} else if (message.getType().equals(MessageType.PUSH) && pushNotification != null) {
			pushNotification.publish(message);
		} else if (message.getType().equals(MessageType.SMS) && smsNotification != null) {
