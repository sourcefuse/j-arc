...
public class UserSignupExampleController {
    ...
    public ResponseEntity<String> createUserTenants(
        ...
        UserCredentials userCredentials = userCredentialRepository.
                findOne(UserCredentialsSpecification.byUserId(userDto.getUserDetails().getId()))
                .map(credentials -> {
        ...
        return   new ResponseEntity<>("success", isCreated.get() ? HttpStatus.CREATED:HttpStatus.OK);
    }
