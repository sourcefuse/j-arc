    ...
    if (!this.inviteUserForm.invalid) {
      const requestBody: UserDto = new UserDto({
        ...
        userDetails: new User({
          firstName: this.inviteUserForm.value.firstName || this.inviteUserForm.value.email,
          lastName: this.inviteUserForm.value.lastName || this.inviteUserForm.value.email,
